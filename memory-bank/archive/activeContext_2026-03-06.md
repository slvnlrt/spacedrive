...
- **Jan 23, 2026**: Synchronized with `upstream/main` - merged 12 new commits (Mobile UI, Dependency fixes). Resolved conflicts in `manager.rs` and `useNormalizedQuery.ts`.
